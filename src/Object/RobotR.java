...
public class RobotR extends PartiObject {
    ...
    public RobotR(float x, float y, WorldState gameWorld) {
        super(x, y, 127, 89, 0, 100, gameWorld);
        backAnim = Loader_CacheData.getInstance().getAnimation("robotR");
        forwardAnim = Loader_CacheData.getInstance().getAnimation("robotR");
        ...
        shooting = Loader_CacheData.getInstance().getSound("robotRshooting");
    }
