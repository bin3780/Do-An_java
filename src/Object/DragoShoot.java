...
public class DragoShoot extends Bullet
{

    public DragoShoot(float x, float y,WorldState gameWorld) {
        super(x, y, 60, 30, 1.0f, 50, gameWorld);
        //TODO Auto-generated constructor stub
        forwardBulletAnim = Loader_CacheData.getInstance().getAnimation("dragonshoot");
        backBulletAnim = Loader_CacheData.getInstance().getAnimation("dragonshoot");
